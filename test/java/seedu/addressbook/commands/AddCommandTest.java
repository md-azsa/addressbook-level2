...
public class AddCommandTest {
    ...
    public void addCommand_invalidName_throwsException() {
        ...
        for (String name : invalidNames) {
            assertConstructingInvalidAddCmdThrowsException(name, Phone.EXAMPLE, true, Email.EXAMPLE, false,
                    Address.EXAMPLE, true, DateOfBirth.EXAMPLE, false, EMPTY_STRING_LIST);
        }
    }
    ...
    public void addCommand_invalidPhone_throwsException() {
        ...
        for (String number : invalidNumbers) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, number, false, Email.EXAMPLE, true,
                    Address.EXAMPLE, false, DateOfBirth.EXAMPLE, false, EMPTY_STRING_LIST);
        }
    }
    ...
    public void addCommand_invalidAddress_throwsException() {
        ...
        for (String address : invalidAddresses) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE,
                    true, address, true, DateOfBirth.EXAMPLE, false, EMPTY_STRING_LIST);
        }
    }

    @Test
    public void addCommand_invalidDateOfBirth_throwsException() {
        final String[] invalidDOB = {"ss.ss.ss", "", " ", "122.2222.112233", "ssss.sss", "s.", "s.asdqw[][]p"};
        for (String dob : invalidDOB) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE, false,
                    Address.EXAMPLE, true, dob, false, EMPTY_STRING_LIST);
        }
    }
    ...
    public void addCommand_invalidTags_throwsException() {
        ...
        for (String[] tags : invalidTags) {
            ...
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE,
                    true, Address.EXAMPLE, false, DateOfBirth.EXAMPLE, false, tagsToAdd);
        }
    }
    ...
    private void assertConstructingInvalidAddCmdThrowsException(String name, String phone,
            ...
            boolean isAddressPrivate, String dob, boolean isDateOfBirthPrivate, Set<String> tags) {
        try {
            new AddCommand(name, phone, isPhonePrivate, email, isEmailPrivate, address, isAddressPrivate, dob, isDateOfBirthPrivate,
                    tags);
        ...
        String error = String.format(
                ...
                name, phone, isPhonePrivate, email, isEmailPrivate, address, isAddressPrivate, dob, isDateOfBirthPrivate, tags);
        fail(error);
    }
