...
public class AdaptedPerson {
    ...
    public boolean isAnyRequiredFieldMissing() {
        ...
        return Utils.isAnyNull(name, phone, email, address, dob)
                || Utils.isAnyNull(phone.value, email.value, address.value, dob.value);
    }
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        final DateOfBirth dob = new DateOfBirth(this.dob.value, this.dob.isPrivate);
